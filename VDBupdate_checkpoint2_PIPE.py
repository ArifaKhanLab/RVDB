...
print logfolder
outf=open(logdir+'\\'+'RVDBv'+version+'_checkpt2a.log','w')
unzipfns=[]
...
relnotes=sys.argv[4]
homedir='F:\\RVDBv'+currentvs+'_PIPE'
...
logdir=gbdir+'\\log'
input_filenames=sys.stdin.readlines()

logdir='F:\\UPDATE_SCRIPTS_LOGS'
logfolder='logs_'+currentvs
##### Put release file for update here #####
gbrelfilename=logdir+'\\'+logfolder+'\\'+relnotes
